          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {paginatedPrograms.map((program) => (
              <motion.div
                ...
                className="bg-white rounded-lg border-2 overflow-hidden shadow-lg hover:shadow-xl transition-all"
                style={{ borderColor: "#e5e7eb" }}
              >
                <div className={`h-1 w-full ${program.color.split(' ')[0]}`} />
                <div className="relative h-32 overflow-hidden bg-slate-100">
                  ...
                  <div className="absolute top-2 left-2">
                    <div className={`w-8 h-8 rounded-lg ${program.color} flex items-center justify-center shadow-md`}>
                ...
                <div className="p-4">
                  <div className="flex items-start justify-between mb-2">
                    <h4 className="text-sm font-bold text-slate-900 line-clamp-2">{program.title}</h4>
                  ...
                  <div className="space-y-1.5 mb-3">
                    ...
                    <div className="flex items-center gap-2 text-xs text-slate-600">
                      ...
                      <span>{program.locations.length} location{program.locations.length > 1 ? 's' : ''}</span>
                    </div>
                  </div>
                </div>
              </motion.div>
