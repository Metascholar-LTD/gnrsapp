      ...
      <div id="ude-content">
        ...
        <div className={`ude-section ${activeTab === 'admissions' ? 'active' : ''}`}>
          ...
          <div className="ude-form-grid">
            ...
            <div className="ude-form-group">
              <label className="ude-form-label">WASSCE Score Range</label>
              <input
                type="text"
                name="admissions.wassceScoreRange"
                value={formData.admissions?.wassceScoreRange || ""}
                onChange={handleInputChange}
                className="ude-form-input"
                placeholder="e.g., Aggregate 6-24"
              />
        ...
        <div className={`ude-section ${activeTab === 'contact' ? 'active' : ''}`}>
          ...
          <div style={{ marginTop: "2rem" }}>
            <h4 style={{ fontSize: "0.875rem", fontWeight: 600, color: "#374151", margin: "0 0 1rem 0", textTransform: "uppercase", letterSpacing: "0.05em" }}>Social Media</h4>
            <div className="ude-form-grid">
              <div className="ude-form-group">
                <label className="ude-form-label">Facebook URL</label>
                <input
                  type="url"
              ...
              <div className="ude-form-group">
                <label className="ude-form-label">LinkedIn URL</label>
                <input
                  type="url"
              ...
              <div className="ude-form-group">
                <label className="ude-form-label">YouTube URL</label>
                <input
                  type="url"
                  ...
                  onChange={handleInputChange}
                  className="ude-form-input"
                  placeholder="https://youtube.com/@university"
                />
              </div>

              <div className="ude-form-group">
                <label className="ude-form-label">Instagram URL</label>
                <input
                  type="url"
