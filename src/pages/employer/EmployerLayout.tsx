...
const EmployerLayout: React.FC = () => {
  ...
  return (
    <>
      {/* Scoped Sneat Styles - Same as SneatLayout */}
      <style>{`
      ...
      <div className="layout-container">
        ...
        <aside id="layout-menu" className={`layout-menu menu-vertical menu bg-menu-theme ${menuOpen ? 'show' : ''}`}>
          <div className="app-brand demo">
            <Link to="/employer" className="app-brand-link">
              ...
              <span className="app-brand-text demo menu-text fw-bolder ms-2">Employer</span>
            </Link>
