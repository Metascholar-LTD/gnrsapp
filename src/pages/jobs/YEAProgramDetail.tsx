...
const YEAProgramDetail = () => {
    ...
    const loadProgram = async () => {
      if (id) {
        ...
        try {
          ...
          if (error) {
            console.error("Error loading YEA program:", error);
            setLoading(false);
            return;
          }
  ...
  const goBack = () => navigate("/jobs/yea-jobs");
  ...
  const handleApply = () => {
    if (program?.application_url) {
      ...
      window.open("https://www.yea.gov.gh", '_blank', 'noopener,noreferrer');
    }
  };

  const heroImageUrl = program?.image_url || "https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1200&auto=format&fit=crop&q=60";
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-2xl mx-auto bg-white border border-slate-200 rounded-2xl shadow-sm p-8 text-center">
              <div className="flex flex-col items-center gap-4">
                ...
                <h1 className="text-2xl font-bold text-slate-900">YEA Program Not Found</h1>
                <p className="text-slate-600">We couldn't find the YEA program you're looking for.</p>
                <Button onClick={goBack} className="bg-slate-900 hover:bg-slate-800 text-white px-6">
                  Back to YEA Programs
                </Button>
              </div>
            </div>
          </div>
            ...
            {fieldOperationGroups.length > 0 ? (
              <>
                <p className="text-slate-600">
                  Day-to-day responsibilities and operational activities in this YEA program.
                </p>
        ...
        return (
          <section className="space-y-6">
            ...
            {hasBehavioralAttributes && (
              <div className="rounded-2xl bg-emerald-50 border border-emerald-100 p-5">
                <h3 className="text-base font-semibold text-emerald-900 mb-2">Behavioural Attributes</h3>
      ...
      default:
        ...
        return (
          <section className="space-y-6">
            ...
            <div className="rounded-2xl bg-emerald-50 border border-emerald-100 p-5 space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-slate-900">Ready to Join YEA?</h3>
                <p className="text-sm text-slate-600">Apply through the official YEA portal or use the program-specific application link.</p>
              </div>
            </div>
          </section>
        );
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <div className="flex items-center gap-2 text-emerald-400 text-xl mb-6">
                ...
                <span className="font-semibold">Youth Employment Agency</span>
              </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="group flex items-start gap-3 p-3 rounded-xl bg-white/80 hover:bg-white border border-slate-100 hover:border-emerald-200/60 hover:shadow-md transition-all duration-300 ease-out">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm font-semibold text-slate-900">{program.stipend}</p>
                      </div>
                    </div>
                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-slate-600">
                      Join thousands of young Ghanaians building their futures through YEA employment and skills development.
                    </p>
                    <Button 
...
export default YEAProgramDetail;
