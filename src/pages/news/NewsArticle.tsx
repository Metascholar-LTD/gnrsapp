...
const articles: Record<string, {
  ...
  "3": {
    ...
    content: [
      "The Ashanti Regional Government has unveiled a comprehensive development initiative aimed at transforming infrastructure and public services across the region. The ambitious program, announced by the Regional Minister, includes major investments in road networks, public transportation, water supply systems, and educational facilities.",
      "Key projects in the initiative include the expansion and rehabilitation of major highways connecting Kumasi to surrounding districts, the construction of new bridges to improve connectivity, and the upgrade of public transportation systems. The regional government has committed over $150 million to these infrastructure improvements over the next three years.",
      "The development projects are expected to create thousands of jobs for local residents and significantly improve the quality of life for communities across the Ashanti Region. The initiatives also include partnerships with private sector investors to ensure sustainable development and economic growth.",
      "Local leaders and community representatives have welcomed the announcement, noting that improved infrastructure will enhance trade, facilitate access to markets, and attract new businesses to the region. The projects align with the government's broader vision of regional development and decentralization.",
    ],
